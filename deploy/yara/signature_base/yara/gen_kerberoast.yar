...
rule GetUserSPNs_VBS {
	meta:
		description = "Auto-_Duplicategenerated rule - file GetUserSPNs.vbs"
...
rule GetUserSPNs_PS1 {
	meta:
		description = "Auto-_Duplicategenerated rule - file GetUserSPNs.ps1"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
		reference = "https://github.com/skelsec/PyKerberoast"
		date = "2016-05-21"
...
rule kerberoast_PY {
	meta:
		description = "Auto-_Duplicategenerated rule - file kerberoast.py"
		license = "Detection Rule License 1.1 https://github.com/Neo23x0/signature-base/blob/master/LICENSE"
		author = "Florian Roth (Nextron Systems)"
		reference = "https://github.com/skelsec/PyKerberoast"
		date = "2016-05-21"
