/*
	...
	Warning: Don't use this rule set_Duplicate without excluding the false positive hashes listed in
...
rule Regin_APT_KernelDriver_Generic_A {
	meta:
		description = "Generic rule for_Duplicate Regin APT kernel driver Malware - Symantec http://t.co/qu53359Cb2"
...
rule Regin_Sample_1 {
   meta:
      description = "Semiautomatically generated YARA rule -_Duplicate file-3665415_sys"
      author = "Florian Roth"
      date = "25.11.14"
      score = 70
...
rule Regin_Sample_2 {
	meta:
		description = "Auto-_Duplicategenerated rule - file hiddenmod_hookdisk_and_kdbg_8949d000.bin"
		author = "@MalwrSignatures"
		date = "26.11.14"
...
rule Regin_Sample_Set_2 {
	meta:
		description = "Auto-_Duplicategenerated rule - file SHF-000052 and ndisips.sys"
		author = "@MalwrSignatures"
		date = "26.11.14"
