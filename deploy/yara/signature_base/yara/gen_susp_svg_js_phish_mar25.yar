...
rule SUSP_SVG_JS_Payload_Mar25 {
   meta:
      description = "Detects a suspicious SVG file that contains a JavaScript payload. This_Duplicate rule is a generic rule that might generate false positives. A match should be further investigated."
      author = "Florian Roth"
