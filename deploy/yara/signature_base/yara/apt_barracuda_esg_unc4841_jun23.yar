...
rule APT_MAL_LNX_Hunting_Linux_WHIRLPOOL_1 {
    meta:
        description = "Hunting rule looking_Duplicate for strings observed in WHIRLPOOL samples."
        author = "Mandiant"
        date = "2023-06-15"
        score = 70
        reference = "https://www.mandiant.com/resources/blog/barracuda-esg-exploited-globally"
...
rule APT_MAL_LUA_Hunting_SKIPJACK_1 {
    meta:
        ...
        date = "2023-06-15"
        reference = "https://www.mandiant.com/resources/blog/barracuda-esg-exploited-globally"
        description = "Hunting rule looking_Duplicate for strings observed in SKIPJACK installation script."
...
rule APT_MAL_LUA_Hunting_Lua_SKIPJACK_2 {
    meta:
        ...
        date = "2023-06-15"
        reference = "https://www.mandiant.com/resources/blog/barracuda-esg-exploited-globally"
        description = "Hunting rule looking_Duplicate for strings observed in SKIPJACK samples."
...
rule APT_MAL_LUA_Hunting_Lua_SEASPRAY_1 {
    meta:
        ...
        date = "2023-06-15"
        reference = "https://www.mandiant.com/resources/blog/barracuda-esg-exploited-globally"
        description = "Hunting rule looking_Duplicate for strings observed in SEASPRAY samples."
