    ...
    async fn process_kev_intelligence(&self, kev: &osoosi_types::Kev) -> anyhow::Result<()> {
        let intel = GlobalIntelligence {
            ...
            summary: format!(
                ...
                kev.vulnerability_name, kev.cve_id
            ),
        ...
        let _ = self
            .mesh_tx
            .send(osoosi_wire::MeshCommand::BroadcastGlobalIntel(intel))
            .await;
        Ok(())
    }
    ...
    async fn scout_trending_vulnerabilities(&self) -> anyhow::Result<()> {
        ...
        let mock_intel = GlobalIntelligence {
            ...
            defense: Some(ZeroDayDefense {
                ...
                description: "Deep-packet inspection rule to block anomalous header smuggling."
                    .to_string(),
                severity: 1.0,
        ...
        let _ = self
            .mesh_tx
            .send(osoosi_wire::MeshCommand::BroadcastGlobalIntel(mock_intel))
            .await;
        Ok(())
    }

    /// Broadcast a specific Indicator of Compromise (IOC) detected locally.
    pub async fn broadcast_ioc(
        &self,
        type_id: &str,
        value: &str,
        severity: f32,
        ...
        let intel = GlobalIntelligence {
            ...
            defense: Some(ZeroDayDefense {
                ...
                description: format!(
                    "Automatically generated block rule for {} {}",
                    type_id, value
                ),
                severity,
                learned_rule: format!(
                    "rule mesh_block_{} {{ condition: hash == \"{}\" }}",
                    type_id, value
                ),
